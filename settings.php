    ...
    <div class="flex-none md:max-w-xs text-black">
      <div @click.away="open = false"
        ...
        <nav :class="{'block': open, 'hidden': !open}"
          ...
          <a class="showSingle block px-10 py-4 text-sm font-semibold rounded-t-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-white focus:text-white hover:bg-gray-200 bg-blue-sidebar focus:outline-none focus:shadow-outline"
             target="1" href="#div1">Account</a>
          <a class="showSingle block px-10 py-4 text-sm font-semibold bg-transparent dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-white focus:text-white hover:bg-gray-200 bg-blue-sidebar focus:outline-none focus:shadow-outline"
             target="2" href="#div2">Security</a>
          <a class="showSingle block px-10 py-4 text-sm font-semibold bg-transparent dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-white focus:text-white hover:bg-gray-200 bg-blue-sidebar focus:outline-none focus:shadow-outline"
             target="3" href="#div3">Deletion</a>
        </nav>
      </div>
    </div>
                ...
                <div class="flex justify-center">
                  <div class="mt-1 flex items-center">
                    ...
                    <div class="flex flex-col space-y-2">
                      <button type="button"
                              class="ml-5 bg-blue-save py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Choose File
                      </button>
                      <button type="button"
                    ...
                    <div class="w-full">
                      ...
                      <div class="mt-1">
                        <textarea id="about" name="about" rows="4"
                                  class="w-full shadow-sm text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"> </textarea>
                      </div>
                    </div>
