                ...
                <div class="max-w-lg flex flex-wrap mx-auto">
                  ...
                  <div class="w-full space-y-2">
                    ...
                    <div class="flex justify-center px-4 py-3 text-right sm:px-6 space-x-6 hidden" id="btnCS">
                      <button class="inline-flex justify-center py-3 px-7 border shadow-sm text-sm rounded-lg add-button cursor-pointer">Save</button>
        ...
        <div id="div1" class="targetDiv  mt-5 md:mt-0 md:col-span-2">
          <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 pt-5 pb-12 bg-white space-y-6 sm:p-6">
                ...
                <div class="flex justify-center">
                  <div class="mt-1 flex items-center">
                    ...
                    <div class="flex flex-col space-y-2">
                      ...
                      <input type="submit" name="submit-file" value="Upload Now" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer">
                    </div>
                  </div>
                </div>
              </form>
              <form action="change_info.php" method="POST">
                <div class="px-28 flex justify-end">
                  <div name="edit" id="edit" class="cursor-pointer py-1 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-gray-600 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Edit
                  </div>
                </div>
                <!-- Input Fields  -->
