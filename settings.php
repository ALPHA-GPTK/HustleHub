    ...
    <div class="md:flex px-36">
      ...
      <div class="flex-none md:max-w-xs text-black">
        <div @click.away="open = false"
             class="flex flex-col w-full md:w-64 text-gray-700 bg-white dark-mode:text-gray-200 rounded-lg dark-mode:bg-gray-800 flex-shrink-0"
             x-data="{ open: false }">
          <div class="px-8 flex flex-row items-center justify-between">
            <button class="rounded-lg md:hidden rounded-lg focus:outline-none focus:shadow-outline"
              ...
              <svg fill="currentColor" viewBox="0 0 20 20" class="w-6 h-6">
                ...
                <path x-show="open" fill-rule="evenodd"
                      d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0l 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                      clip-rule="evenodd"></path>
              </svg>
            </button>
          </div>
          <nav :class="{'block': open, 'hidden': !open}"
               class="sidebar flex-grow md:block w-full mb-44 md:pb-0 md:overflow-y-auto">
            <a class="showSingle block px-10 py-4 text-sm font-semibold cursor-pointer rounded-t-lg c-darkBlue_65 btn-sidebar active"
               target="1" id="btn-basic">Account</a>
            <a class="showSingle block px-10 py-4 text-sm font-semibold cursor-pointer btn-sidebar c-darkBlue_65"
               target="2" id="btn-security">Security</a>
            <a class="showSingle block px-10 py-4 text-sm font-semibold cursor-pointer btn-sidebar c-darkBlue_65"
               target="3" id="btn-deletion">Deletion</a>
          </nav>
        </div>
      </div>
                ...
                <form action="change_info.php" method="POST">
                  ...
                  <div class="max-w-lg flex flex-wrap mx-auto">
                    <div class="w-full md:w-1/2 pr-2">
                      ...
                      <input value="<?= $user_firstname ?>"
                             class="w-full h-10 pl-3 pr-8 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"
                             type="text" name="fName" id="fName" disabled/>
                    </div>
                    <!-- Last Name -->
                    <div class="w-full md:w-1/2 mb-2">
                      <label class="block mb-1 text-xs text-gray-600 font-black uppercase" for="lName">Last name</label>
                      <input value="<?= $user_lastname ?>"
                             class="w-full h-10 pl-3 pr-8 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"
                             type="text" name="lName" id="lName" disabled/>
                    </div>
                    <!-- Other Credentials -->
                    <div class="w-full space-y-2">
                      ...
                      <div class="w-full">
                        ...
                        <div class="mt-1">
                          ...
                          <textarea
                                  ...
                                  id="about" name="about" rows="4" disabled>
                      ...
                      <div class="flex justify-center px-4 py-3 text-right sm:px-6 space-x-6" id="btnCS">
                        ...
                        <button name="change-info" type="submit"
                  ...
                  <div class="max-w-lg flex flex-wrap mx-auto">
                    <div class="w-full space-y-2">
                      ...
                      <label for="current-password"
                             class="block text-xs text-gray-600 dark:text-gray-400 uppercase font-black">Current
                        Password</label>
                      <div class="relative text-gray-700">
                        <label>
                          <input class="w-full h-10 pl-3 pr-12 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"
                                 type="password" name="current-password" id="current-password" required/>
                        </label>

                        <!-- svg hide password icon -->
                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 cursor-pointer">
                          <img src="./assets/img/hide.svg" alt="password-icon" class="h-6 w-6 hide"
                      ...
                      <label for="new-password"
                             class="block text-xs text-gray-600 dark:text-gray-400 uppercase font-black">
                        New Password
                      </label>
                      <div class="relative text-gray-700">
                        <label>
                          <input class="w-full h-10 pl-3 pr-12 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"
                                 type="password" name="new-password" id="new-password" required/>
                        </label>
                      ...
                      <div class="relative text-gray-700">
                        <label>
                          <input class="w-full h-10 pl-3 pr-12 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"
                                 type="password" name="confirm-password" id="confirm-password" required disabled/>
                        </label>

                        <!-- svg check password icon -->
                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                          <img src="./assets/img/check-not.svg" alt="check-icon" class="h-6 w-6"
                      ...
                      <div class="flex justify-center px-4 py-3 text-right sm:px-6 space-x-6">
                        <input type="reset" value="Cancel" name="cancelPass"
                               class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-blue-change hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer"/>
                        <input type="submit" value="Save" name="changePass"
                               class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-blue-save focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer"/>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="max-w-full text-left">
                    ...
                    <div class="px-8 flex justify-end">
                      <button name="delete" type="submit"
                              class="py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white account-delete-button account-delete-button:hover">
                        Delete Account
                      </button>
                    </div>
                  </div>
