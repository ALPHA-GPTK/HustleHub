        ...
        <div class="flex-none md:max-w-xs text-black">
          <div @click.away="open = false" class="flex flex-col w-full md:w-64 text-gray-700 bg-white dark-mode:text-gray-200 rounded-lg dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
            ...
            <nav :class="{'block': open, 'hidden': !open}" class="sidebar flex-grow md:block w-full mb-44 md:pb-0 md:overflow-y-auto">
              <a class="block px-10 py-4 text-sm font-semibold rounded-t-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-white focus:text-white hover:bg-gray-200 bg-blue-sidebar focus:outline-none focus:shadow-outline" href="#">Account</a>
              <a class="block px-10 py-4 text-sm font-semibold bg-transparent dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-white focus:text-white hover:bg-gray-200 bg-blue-sidebar focus:outline-none focus:shadow-outline" href="#">Security</a>
              <a class="block px-10 py-4 text-sm font-semibold bg-transparent dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-white focus:text-white hover:bg-gray-200 bg-blue-sidebar focus:outline-none focus:shadow-outline" href="#">Deletion</a>
            </nav>
          </div>
        </div>
