        ...
        <section class="mx-auto">
            ...
            <div class="antialiased pl-14 pr-14">
                <div class="flex justify-end">
                    <a href="./add_gigs.php" class="py-2 px-4 mb-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-gray-600 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add Gigs</a>
                </div>
                ...
                <div class="flex flex-wrap -mx-4">
                    ...
                    $sql = "SELECT gigs_id, gigs_service, gigs_description, gigs_price, gigs_rating, gigs_creation FROM freelance_gig WHERE user_id = '$userId'";
                            ...
                            <div href="" class="card-gig block shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="px-6 py-4">
                                        ...
                                        <div class="font-bold text-xl mb-2 mt-10"><?php echo ucwords($userResult['gigs_service']); ?></div>
