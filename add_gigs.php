          ...
          <div class="max-w-lg flex flex-wrap mx-auto">
            ...
            <div class="w-full pr-2">
              ...
              <div class="relative margin">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-4 cursor-pointer">
                  <img src="./assets/img/dropdown-icon.svg" alt="password-icon" class="h-6 w-6 hide"
            ...
            <div class="w-full space-y-2">
              ...
              <div class="relative text-gray-700">
                <label>
                  <textarea rows="20" cols="50" form="addgigs"
                            class="w-full h-24 py-2 pl-3 pr-8 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500"
                            name="description" id="description" placeholder="Enter your description..."
                            required></textarea>
                </label>
              </div>
              <!-- Banner -->
              ...
              <div class="border border-dashed border-gray-500 relative">
                <input type="file" id="banner" name="imgToUpload" multiple
                       class="cursor-pointer relative block opacity-0 p-20 z-50">
              ...
              <div class="relative text-gray-700">
                <label>
                  <input onkeypress="return isNumberKey(event)"
                         class="w-full h-10 pl-3 pr-8 text-base rounded-md border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500 appearance-none"
              ...
              <div class="flex justify-center px-4 py-3 text-right sm:px-6 space-x-6">
                <a href="./mygigs.php"
                   class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-blue-change hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer">Cancel</a>
                <input type="submit" value="Add" name="addGigs"
